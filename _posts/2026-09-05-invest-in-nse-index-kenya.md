...
categories: [stocks]
tags: [NSE indices, NSE 25 Share Index, index futures, ETFs in Kenya, options trading in Kenya, binary options, investing in Kenya]
permalink: /blog/invest-in-nse-index-kenya/
image: /assets/images/invest-in-nse-index-kenya.jpg
image_alt: "Illustration comparing NSE index ETFs, shares, futures and options for Kenyan investors"
image_caption: "An index is a measurement, not a share. Kenyan investors can get exposure through ETFs, shares or NSE derivatives, but each route works differently."
image_source_name: "Kenya MMF Calculator"
image_license: "Original editorial graphic"
math: true
faq:
  - q: "Can I buy the NSE 25 Share Index directly?"
    a: "No. The index is a calculated measure, not a security. You can trade NSE 25 futures or buy the constituent shares. At publication, there was no broad NSE 25-tracking ETF on the NSE."
  - q: "Is there an NSE 20 index fund in Kenya?"
    a: "No NSE 20 ETF appeared on the NSE price list checked for this article. Products change, so verify the latest NSE listings before acting."
  - q: "What is an ETF in simple terms?"
    a: "An ETF is a fund whose units trade on an exchange like shares. It can hold a basket of shares or another asset and aim to follow a benchmark."
  - q: "Is the WSA Banking Index ETF the same as the NSE 25?"
    a: "No. It is designed to track the NSE Banking Sector Index and hold the 11 listed banking companies. It is a sector fund, not a broad NSE 25 tracker."
  - q: "How much is needed for one Mini NSE 25 futures contract?"
    a: "The NSE's June 2026 notice set initial margin at KSh 3,300 for the September 2026 contract, rising for later expiries. This amount can change, and a broker may require more. Confirm the current figure before trading."
  - q: "Do I need a CDS account to trade NSE index futures?"
    a: "Shares and ETFs are held through the normal securities-market account structure. NEXT derivatives require onboarding through an approved derivatives trading member, including KYC, agreements and risk disclosures. Ask the broker whether it can connect this to your existing client profile."
  - q: "Are options available on the NSE?"
    a: "Yes. The NSE launched options on selected single-stock futures in June 2026. Published contracts covered Safaricom, KCB, Equity, Co-op Bank, I&M and KenGen. Availability does not guarantee enough liquidity for a practical trade."
  - q: "Are binary options the same as NSE options?"
    a: "No. A binary option normally has a fixed all-or-nothing payout based on a yes-or-no event. A conventional NSE option gives its buyer a contractual right linked to an underlying futures contract, with a payoff that changes rather than staying fixed."
  - q: "Are NSE futures safer than binary options?"
    a: "Exchange trading, licensed members and central clearing reduce certain provider and counterparty risks. Futures still carry high market risk because they are leveraged. You can lose the initial margin and may have to add more money."
  - q: "Do NSE index futures pay dividends?"
    a: "No. A futures holder does not own the underlying companies and receives no dividends or voting rights."
---
...
1. Buy an exchange-traded fund (ETF) that tracks the index, if one is listed and trading.
2. Buy some or all of the shares that make up the index through a CDS account.
3. Trade an index futures contract on the NSE derivatives market, known as NEXT.
...
The constituents and rules of an index can change. The NSE publishes its current [index ground rules](https://www.nse.co.ke/rules/), while its daily price lists show which securities and derivatives are actually available.
...
Kenya's ETF market is changing. On 11 August 2026, the Capital Markets Authority approved the [WSA Banking Index ETF](https://www.cma.or.ke/cma-approves-innovative-exchange-traded-fund-to-diversify-and-deepen-the-capital-markets/) for listing on the NSE. The CMA described it as Kenya's first locally domiciled ETF.
...
Approval is an important milestone, but investors should confirm the first trading date with the NSE or their broker. The [NSE daily price list for 3 September 2026](https://www.nse.co.ke/wp-content/uploads/03-SEP-26.pdf) displayed Absa NewGold ETF and Satrix MSCI World Feeder ETF, but not the WSA Banking Index ETF.
...
1. Open a CDS account with a licensed stockbroker or investment bank.
2. Fund the linked trading account.
3. Confirm the ETF's official ticker, current bid and offer prices, and trading status.
4. Read its information memorandum, including fees, dividend policy and risks.
5. Place an order through the broker.

If you do not yet have an account, start with our [step-by-step guide to opening a CDS account in Kenya](/blog/how-to-open-cds-account-kenya/).
...
According to the [NSE derivatives price list dated 3 September 2026](https://www.nse.co.ke/dataservices/wp-content/uploads/Derivatives_Pricelist_03-SEP-2026.pdf), NEXT listed four index-futures products:

| Contract | Code | Underlying index |
|---|---|---|
| NSE 25 Index Future | `N25I` | NSE 25 Share Index |
| Mini NSE 25 Index Future | `25MN` | NSE 25 Share Index |
| Mini NSE 10 Index Future | `10MN` | NSE 10 Share Index |
| NSE Banking Sector Index Future | `NBSI` | NSE Banking Sector Index |
...
The [NSE derivatives FAQ](https://www.nse.co.ke/derivatives/faq/) explains the clearing, margin and settlement process.
...
The [NSE margin notice effective 19 June 2026](https://www.nse.co.ke/derivatives/wp-content/uploads/sites/6/2026/07/Market-Notice-Initial-Margins-June-2026.pdf) set these initial margins for the Mini NSE 25:
...
$$
\text{Long P\&L} = (\text{exit futures price} - \text{entry futures price}) \times \text{KSh 10} \times \text{contracts}
$$

For a short position, the subtraction is reversed:

$$
\text{Short P\&L} = (\text{entry futures price} - \text{exit futures price}) \times \text{KSh 10} \times \text{contracts}
$$

Assume you buy one Mini NSE 25 future at 7,100 and later sell it at 7,150:

$$
(7{,}150 - 7{,}100) \times \text{KSh 10} = \text{KSh 500 profit}
$$

Your approximate market exposure at entry is:

$$
7{,}100 \times \text{KSh 10} = \text{KSh 71,000}
$$

Using the KSh 3,300 September 2026 initial margin, that KSh 500 gain equals about 15.2% of the margin deposit before fees:

$$
\frac{500}{3{,}300} \times 100 = 15.2\%
$$

But leverage works both ways. If you exited at 7,050, the same trade would lose KSh 500, also about 15.2% of the starting margin. A larger adverse move could consume the deposit and require you to add money.
...
The NSE introduced [options on single-stock futures for trading from 19 June 2026](https://www.nse.co.ke/derivatives/wp-content/uploads/sites/6/2026/06/Market-Notice-Listing-of-Options-on-Futures-Contracts.pdf). The initial underlyings were:
...
<div class="table-wrap nse-comparison-wrap" markdown="1">
...
The US SEC and CFTC have received complaints involving internet-based binary-options platforms, including [denied withdrawals, identity theft and alleged software manipulation](https://www.investor.gov/protect-your-investments/fraud/types-fraud/binary-options-fraud). That warning does not prove that every binary option or platform is fraudulent, and it is not a ruling on Kenyan law. It does show why provider verification matters.

For a Kenyan investor:

- search for the firm in the [CMA directory of licensed market players](https://licensees.cma.or.ke/);
...
1. Decide whether you want broad-market or banking-sector exposure.
2. Open and fund a CDS account through a CMA-licensed broker.
3. Confirm that the ETF or share is admitted and actively trading.
4. Read the product documents and compare fees, spread, liquidity and concentration.
5. Invest gradually and keep money needed soon out of volatile shares.
...
1. Choose a firm on the NSE's current list of [licensed NEXT trading members](https://www.nse.co.ke/derivatives/accredited-members/).
2. Cross-check the firm and licence in the CMA directory.
3. Complete the derivatives account, KYC agreement and risk disclosures.
4. Ask for the live contract specification, initial margin, total fees and broker close-out policy.
5. Calculate the shilling loss from a realistic adverse move before placing the trade.
6. Use money you can afford to lose, never rent, school fees, emergency savings or borrowed cash.
...
| Express or hedge a view on the NSE 25 | `N25I` or `25MN` future | Leverage, daily margin and expiry |
| Express or hedge a view on the NSE 10 | `10MN` future | Leverage and liquidity |
| Express or hedge a view on listed banks | `NBSI` future | Sector risk, leverage and liquidity |
