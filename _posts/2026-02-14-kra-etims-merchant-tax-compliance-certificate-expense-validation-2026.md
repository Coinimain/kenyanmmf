...
image_caption: "KRA eTIMS 2026: Merchant Tax Compliance Certificate + Expense Validation"
image_credit: "Kenya MMF Calculator (Canva)"
image_license: "All rights reserved"
permalink: /kra-etims-merchant-tax-compliance-certificate-expense-validation-2026/
...
faqs:
  - q: "What is eTIMS?"
    a: "eTIMS (Electronic Tax Invoice Management System) is KRA’s electronic invoicing platform that generates electronic tax invoices and transmits invoice data to KRA. It helps KRA track taxable supplies and validate VAT, income, and expenses."
  - q: "Is eTIMS mandatory in Kenya?"
    a: "For businesses and persons engaged in business activities, eTIMS onboarding is widely required under KRA’s electronic invoicing rules. The specific solution you use depends on your business type, transaction volume, and setup."
  - q: "What changes on 1 January 2026?"
    a: "KRA begins validating income and expenses declared in 2025 tax returns against eTIMS/TIMS invoices, withholding tax records, and customs import data during iTax submission."
  - q: "What is the Merchant Tax Compliance Certificate?"
    a: "It is a proposed KRA compliance certificate that integrates eTIMS compliance—beyond return filing and tax payments—to encourage full adoption of electronic invoicing."
  - q: "If I don’t have a valid eTIMS invoice for an expense, can I still deduct it?"
    a: "Generally, KRA’s validation approach requires declared expenses to be supported by valid electronic tax invoices (with the buyer PIN where applicable), unless the expense falls under exceptions allowed by law (such as Section 23A exemptions)."
  - q: "How do I verify an eTIMS invoice?"
    a: "You can verify invoices by scanning the QR code on the invoice or using the invoice number checker in KRA systems (where available)."
  - q: "What is the eTIMS fuel station system?"
    a: "It’s an eTIMS module for petrol stations that integrates invoicing with dispensers/POS systems so electronic receipts are generated and transmitted to KRA in real time for every fuel transaction."
---
...
## The legal exceptions people forget: Section 23A and “exempt” categories
