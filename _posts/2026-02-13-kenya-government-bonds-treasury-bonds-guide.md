...
faq:
  - q: "What is a Treasury bond in Kenya?"
    a: "A Kenya Treasury bond is a government debt security where you lend money to the Government of Kenya through a CBK auction and receive interest payments (usually every six months) plus principal repayment at maturity (or through amortization for some bonds)."
  - q: "How often are Kenya Treasury bonds auctioned?"
    a: "Treasury bonds are offered through scheduled CBK auctions (often monthly for bonds). The exact dates vary, so you should check the current CBK auction calendar and the latest bond prospectus."
  - q: "What is the minimum amount to invest in a Treasury bond?"
    a: "Minimum investment depends on the specific issue and bid type. Some bonds allow non-competitive bids from around KES 50,000, while competitive bids may have higher minimums (often in the millions). Always confirm in the current prospectus."
  - q: "What is the difference between coupon rate and yield?"
    a: "Coupon rate is the fixed interest rate paid on the bond’s face value, while yield reflects your actual return based on the price you pay (which can be above or below face value) and the time to maturity."
  - q: "Are infrastructure bonds tax-free in Kenya?"
    a: "Some infrastructure bonds may be issued as tax-exempt, which means coupon interest is not subject to withholding tax. This is not automatic for every bond, so confirm the tax treatment in the bond’s prospectus."
  - q: "How do I buy Treasury bonds using DhowCSD?"
    a: "Open a DhowCSD account, monitor upcoming bond auctions, create a bid (competitive or non-competitive), submit before the cut-off time, then pay for successful bids by the settlement deadline using your CSD account details and payment key."
  - q: "Can I sell a Treasury bond before it matures?"
    a: "Yes. You can sell Treasury bonds in the secondary market (typically through a broker/bank) before maturity. The sale price depends on market yields at the time, so you may sell at a profit or loss."
...
Treasury bonds are auctioned by the **Central Bank of Kenya (CBK)**, and investors can participate either:
1) **Directly** (via the **DhowCSD** portal/app), or  
...
- [Treasury bonds vs Treasury bills: what’s the difference?](#treasury-bonds-vs-treasury-bills-whats-the-difference)
- [Why investors like Treasury bonds](#why-investors-like-treasury-bonds)
- [How Treasury bond returns work](#how-treasury-bond-returns-work)
- [Key bond terms you must understand](#key-bond-terms-you-must-understand)
- [Types of Treasury bonds in Kenya](#types-of-treasury-bonds-in-kenya)
- [Taxes: what you keep vs what is withheld](#taxes-what-you-keep-vs-what-is-withheld)
- [How CBK Treasury bond auctions work](#how-cbk-treasury-bond-auctions-work)
- [Step-by-step: how to buy Treasury bonds via DhowCSD](#step-by-step-how-to-buy-treasury-bonds-via-dhowcsd)
- [Competitive vs non-competitive bids (simple explanation)](#competitive-vs-non-competitive-bids-simple-explanation)
- [After the auction: results, payment, settlement](#after-the-auction-results-payment-settlement)
- [Using maturities to pay for new bids (netting)](#using-maturities-to-pay-for-new-bids-netting)
- [Selling before maturity: the secondary market](#selling-before-maturity-the-secondary-market)
- [Bond strategies: laddering for cashflow and flexibility](#bond-strategies-laddering-for-cashflow-and-flexibility)
- [Risks and common mistakes to avoid](#risks-and-common-mistakes-to-avoid)
- [FAQ](#faq)
...
- On web portal: **My account information** → **CSD linking** → activate netting flag  
- On mobile app: **Settings** → **Account** → activate netting
