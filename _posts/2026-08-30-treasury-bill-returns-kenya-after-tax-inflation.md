...
image: /assets/images/treasury-bill-actual-returns-kenya.jpg
image_alt: "Treasury bill actual returns in Kenya showing the published rate, return after tax, and real return after inflation"
image_caption: "A 9.02% published Treasury bill rate falls to approximately 7.57% after tax and 1.10% after accounting for 6.4% inflation."
image_source_name: "Kenya MMF Calculator"
image_license: "Original graphic © Kenya MMF Calculator"

faq:
  - q: "Is the Treasury bill auction rate the return I receive?"
    a: "No. The published rate is used to calculate the bill's discounted price. Your actual return depends on the amount paid, the face value received at maturity, withholding tax and the length of the bill."

  - q: "How are Treasury bill investors paid?"
    a: "Treasury bills are generally purchased below face value. The investor pays the discounted purchase amount plus applicable tax and receives the full face value at maturity."

  - q: "What tax applies to Treasury bills in Kenya?"
    a: "Interest on ordinary Treasury bills is generally subject to 15% withholding tax. Tax rules can change, so investors should confirm the applicable treatment with CBK or KRA before investing."

  - q: "What is the difference between nominal and real return?"
    a: "Nominal return measures the increase in the number of shillings you hold. Real return adjusts that increase for inflation and therefore reflects the change in purchasing power."

  - q: "Can a Treasury bill earn a negative real return?"
    a: "Yes. If inflation exceeds the investor's return after tax, the investor can receive more shillings at maturity while still losing purchasing power."

  - q: "Which Treasury bill had the highest return in this example?"
    a: "On an annualised basis and assuming equivalent reinvestment, the 182-day bill produced the highest estimated net return at approximately 7.70%. The difference between the three bills was small, and future reinvestment rates are unknown."
---
...
The same results showed inflation of 6.4% for June 2026. That figure is consistent with the [Kenya National Bureau of Statistics' June 2026 CPI release](https://www.knbs.or.ke/reports/consumer-price-indices-and-inflation-rates-june-2026/).
...
For example, you might obtain a Treasury bill with a face value of KSh100,000 while paying less than KSh100,000. At maturity, the government pays you KSh100,000. The Central Bank of Kenya describes the same discounted purchase structure in its [guide to investing in government securities](https://www.centralbank.go.ke/securities/).
...
$$
\text{Discounted price}=\frac{\text{Face value}}{1+(\text{rate}\times\text{days}/365)}
$$

Gross interest is then:

$$
\text{Gross interest}=\text{Face value}-\text{discounted price}
$$

Treasury bill interest is generally subject to 15% withholding tax. The tax is deducted from the interest at the start, which increases the total amount the investor must pay for the bill.

$$
\text{Tax}=\text{Gross interest}\times15\%
$$

$$
\text{Total amount paid}=\text{Discounted price}+\text{tax}
$$

Finally:

$$
\text{Net cash profit}=\text{Face value}-\text{total amount paid}
$$

The [CBK Treasury bill calculator](https://www.centralbank.go.ke/bills-bonds/treasury-bills/) follows this pricing structure and allows investors to calculate the price, tax and total offer payment. The [Kenya Revenue Authority](https://www.kra.go.ke/helping-tax-payers/faqs/everything-about-withholding-tax) lists qualifying interest at a 15% withholding-tax rate for resident individuals.
...
$$
\frac{100,000}{1+(0.0902\times364/365)}=KSh91,747.09
$$

### Step 2: Calculate the gross interest

$$
100,000-91,747.09=KSh8,252.91
$$

Notice that the gross interest is not KSh9,020. The 9.02% auction rate is used to price the bill; it is not simply multiplied by the KSh100,000 face value and paid to the investor.

### Step 3: Calculate withholding tax

$$
8,252.91\times15\%=KSh1,237.94
$$

### Step 4: Calculate the total amount paid

$$
91,747.09+1,237.94=KSh92,985.02
$$

### Step 5: Calculate the cash profit

At maturity, the investor receives the KSh100,000 face value:

$$
100,000-92,985.02=KSh7,014.98
$$

The investor therefore commits approximately **KSh92,985** and earns approximately **KSh7,015** over 364 days.

The net holding-period return on the cash actually committed is:

$$
\frac{7,014.98}{92,985.02}\times100=7.54\%
$$

Because the bill runs for 364 rather than exactly 365 days, its approximate effective annualised net return is **7.57%**.
...
This is useful for a quick estimate, but the more accurate formula is:

$$
\text{Real return}=\frac{1+\text{nominal return}}{1+\text{inflation}}-1
$$

For the 364-day bill, using the annualised net return of 7.57% and inflation of 6.4%:

$$
\frac{1.0757}{1.064}-1=1.10\%
$$

The investor's purchasing power therefore grows by approximately **1.10%**, assuming inflation remains at 6.4% over the relevant period.
...
1. Net of taxes and direct costs
2. Annualised over the same period
3. Adjusted for inflation
4. Evaluated alongside risk and liquidity
...
If inflation averaged approximately 6% per year, the land would have lost purchasing power before accounting for legal fees, agent commissions, land rates, fencing, security, transport and capital gains tax.
...
{% comment %}
Replace the placeholder below with the final land-banking article URL after publication.
{% endcomment %}

For a complete breakdown, see: **[Is Land Banking Profitable in Kenya? Calculating the Real Return After Inflation](/land-banking-returns-kenya/)**.
