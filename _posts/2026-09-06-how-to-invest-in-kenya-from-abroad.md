...
tags: [diaspora investment Kenya, invest in Kenya from abroad, money market funds, Treasury bonds, NSE, personal finance]
permalink: /blog/how-to-invest-in-kenya-from-abroad/
image: /assets/images/how-to-invest-in-kenya-from-abroad.jpg
image_alt: "Kenyan diaspora investor comparing regulated investment options in Kenya from abroad"
image_caption: "Kenyans abroad can access regulated investments in Kenya through online platforms and licensed providers."
image_source_name: "Kenya MMF Calculator"
image_license: "Original graphic © Kenya MMF Calculator"
math: true
faq:
  - q: "Can a Kenyan living abroad invest in Kenya?"
    a: >-
  ...
  - q: "Do I need a Kenyan bank account to invest from abroad?"
    a: >-
  ...
  - q: "What is the difference between DhowCSD and a CDSC account?"
    a: >-
  ...
  - q: "Can I open a Kenyan money market fund account while abroad?"
    a: >-
  ...
  - q: "Should a diaspora investor choose a KES or foreign-currency fund?"
    a: >-
  ...
  - q: "What is the safest investment in Kenya for someone in the diaspora?"
    a: >-
  ...
  - q: "Do Kenyans in the diaspora pay tax on investments in Kenya?"
    a: >-
  ...
  - q: "How can I avoid diaspora investment scams in Kenya?"
    a: >-
...
The [Capital Markets Authority's diaspora page](https://www.cma.or.ke/diaspora/) was created to direct Kenyans abroad towards capital-market information and online intermediaries. It is a useful starting point, but parts of the page reflect an earlier market. Today, diaspora investors also have access to DhowCSD, digital CDS account opening and a much wider range of regulated shilling and foreign-currency funds.
...
$$
\text{Foreign-currency return}
=
(1+r_{\text{KES}})\left(\frac{S_0}{S_1}\right)-1
$$

where \(r_{\text{KES}}\) is the investment return, \(S_0\) is the number of shillings bought by one unit of foreign currency at the beginning and \(S_1\) is the exchange rate at the end.
...
Kenya's regulated fund market now includes some USD, euro and sterling sub-funds as well as KES funds. Approval by CMA does not necessarily mean that a newly approved product has already launched or is accepting investors. Verify the exact product in the [CMA register of licensees and approved schemes](https://licensees.cma.or.ke/) and then obtain its current information memorandum.

Before investing, check:

1. the legal name of both the fund manager and the fund;
2. the fund's base currency and permitted contribution currencies;
3. all management, trustee, custody and transaction fees;
4. whether the displayed return is gross or net;
5. the withdrawal period and any early-exit charge;
6. where the assets are invested;
7. whether withdrawals can only return to an account in the investor's name; and
8. how statements, beneficiary details and complaints are handled from abroad.
...
The auction rate is also not the investor's final return after pricing and tax. The guide to [Treasury bill returns in Kenya](/treasury-bill-returns-kenya-after-tax-inflation/) explains how to calculate the approximate net and inflation-adjusted return.
...
An investor normally needs a CDSC securities account connected to a Central Depository Agent, such as a licensed stockbroker or investment bank. CDSC also directs investors to **Dosikaa**, where they can register, choose a participating broker and access shares remotely. The detailed guide to [opening a CDS account in Kenya](/blog/how-to-open-cds-account-kenya/) explains the process.
...
Verify the scheme and its service providers through the [Retirement Benefits Authority](https://www.rba.go.ke/types-of-schemes/). Also confirm how the provider handles foreign contributions, proof of tax residence, beneficiaries and eventual payments to someone living outside Kenya.
...
- check whether the SACCO appears on the relevant [SASRA list for 2026](https://www.sasra.go.ke/download/list-of-licensed-and-authorized-sacco-societies-in-kenya-for-the-financial-year-ending-31st-december-2026/).
...
The earlier analysis of [land-banking returns in Kenya](/land-banking-returns-kenya/) shows why an increase in selling price should be assessed after transaction costs and inflation.

For a remote purchase:

1. appoint an independent Kenyan advocate rather than the seller's advocate;
2. complete an official title search through the relevant land registry or [Ardhisasa](https://ardhisasa.lands.go.ke/) where the service is available;
3. verify the seller's identity, ownership history, survey details, land-use restrictions, rates and rent;
4. commission an independent valuation and physical inspection;
5. pay through traceable accounts specified in formal documents;
6. use written construction milestones instead of informal cash requests; and
7. budget for vacancy, repairs, management, insurance and tax when estimating rental returns.
...
Company searches, licences, contracts, tax status, bank statements and customer evidence should be independently verified. Kenya's [Diaspora Investment Support Office](https://diso.go.ke/) and [InvestKenya](https://www.investkenya.go.ke/) can provide official starting points for larger or enterprise-focused opportunities, but the investor still needs independent financial and legal due diligence.
...
The [CMA investor-protection guidance](https://www.cma.or.ke/investor-information/) advises the public to deal only with licensed institutions. Regulation provides disclosure rules, supervision and a complaints route; it does not promise that an investment cannot lose money.
