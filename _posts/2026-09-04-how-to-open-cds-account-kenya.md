...
faq:
  ...
  - q: "How do I open a CDS account online in Kenya?"
    a: "You can apply through the Dosikaa app or an online account-opening service provided by a licensed stockbroker, investment bank or custodian. You will normally provide identification, a KRA PIN, a photograph and the information required for the CDS 1 form."
  - q: "Is it free to open a CDS account in Kenya?"
    a: "Opening a standard CDS account is generally free. However, you may still pay brokerage commission, statutory transaction charges, money-transfer fees or other provider-specific costs when you begin trading."
  - q: "What documents are required to open a CDS account?"
    a: "An individual applicant normally needs a national ID or valid passport, a KRA PIN certificate, recent colour passport photographs and a completed CDS 1 form. A broker may request extra KYC information such as bank details or proof of address."
  - q: "How long does it take to open a CDS account?"
    a: "Processing time varies by provider and application method. A complete digital application may be processed faster than a manual, company or diaspora application. The account is ready only after you receive confirmation and a CDS account number."
  - q: "Can I open a CDS account without a stockbroker?"
    a: "A personal CDSC account is opened through a licensed Central Depository Agent, such as a stockbroker, investment bank or custodian bank. Dosikaa simplifies the process, but you still choose a participating stockbroker inside the app."
  - q: "Can I open a CDS account through a bank?"
    a: "Yes, if the bank is an authorised custodian or provides the service through its licensed brokerage or investment-banking arm. Not every ordinary bank account or branch automatically includes a CDS account."
  - q: "Can a Kenyan living abroad open a CDS account?"
    a: "Yes. Diaspora investors can apply through providers that support remote onboarding. Certified or notarised identification, proof of address and additional tax or KYC documents may be required."
  - q: "Can I open a CDS account for my child?"
    a: "Yes. A parent or legal guardian can open a minor account using the child's birth certificate together with the guardian's identification and other required documents."
  - q: "Can I have more than one CDS account?"
    a: "Yes. You can open CDS accounts through more than one stockbroker, but each broker can transact only through the account associated with it. Maintaining several accounts may create extra administrative work."
  - q: "Do I need a CDS account to use Ziidi Trader?"
    a: "No. Ziidi Trader uses a pooled or omnibus arrangement, so users do not open separate personal CDS accounts for the shares held through the platform."
  - q: "Is a CDSC account the same as a CBK DhowCSD account?"
    a: "No. A CDSC account is primarily used for investments traded through the Nairobi Securities Exchange, while a CBK DhowCSD account is used to invest directly in Kenyan Treasury bills and Treasury bonds."
---
...
This guide covers the personal CDS account maintained through Kenya's [Central Depository and Settlement Corporation](https://cdsckenya.com/) (CDSC). It is different from the CBK DhowCSD account used to buy Treasury bills and Treasury bonds directly from the Central Bank.

## Quick answer: How to open a CDS account in Kenya

To open a CDS account:

1. Choose a licensed stockbroker, investment bank or custodian bank.
2. Apply through Dosikaa, the provider's website or app, or a physical branch.
3. Provide your ID or passport, KRA PIN and recent photographs.
4. Complete the CDS 1 securities account-opening form.
5. Submit any additional information required for identity verification.
6. Wait for confirmation and your CDS account number.
7. Fund the separate trading account before placing your first order.
...
If your goal is to buy government securities directly from the Central Bank, use [CBK DhowCSD](https://dhowcsd.centralbank.go.ke/) instead. The full process is explained in our [Kenya government bonds guide](/blog/kenya-government-bonds-treasury-bonds-guide/).

A personal CDS account can also hold units bought in a listed REIT. If that is your goal, continue with our [step-by-step guide to investing in a Kenyan REIT](/blog/how-to-invest-in-a-kenyan-reit/) after opening the account.
...
1. Download Dosikaa from the official Google Play Store or Apple App Store listing.
2. Create an account using your correct personal and contact details.
3. Choose the option to open a new CDS account. If you already have one, select the linking option instead.
4. Choose your preferred participating stockbroker.
5. Enter the requested KYC information and upload clear copies of the required documents.
6. Review the names, ID number, KRA PIN and contact information before submitting.
7. Complete any follow-up verification requested by the selected broker.
8. Wait for confirmation that the account has been opened and linked.

The [Dosikaa account-opening service](https://cdsckenya.com/account-opening/) is free. However, the stockbroker you select still matters because that broker will handle your trades, funding and withdrawals.
...
Do not rely on a social-media bio, logo or paid advertisement as proof of authorisation. Check the provider on the [CMA licence register](https://licensees.cma.or.ke/) or the current [CDSC list of Central Depository Agents](https://cdsckenya.com/central-depository-agents/) before sharing documents or money.
...
The NSE maintains a current directory of [mobile and online trading providers](https://www.nse.co.ke/mobile-and-online-trading/). Not every provider uses the same application process, so follow the instructions on the institution's official website.
...
1. Whether the institution opens personal CDSC accounts
2. Whether it provides actual NSE trading or custody only
3. Whether an existing bank account is required
...
The Kenya Pipeline IPO was a recent example of a public offer that required applicants to have valid CDS account details. Our [Kenya Pipeline IPO analysis](/blog/kenya-pipeline-ipo-extended-analysis/) explains the wider investment context.
...
1. Receive your CDS account number and trading credentials.
2. Confirm the provider's official funding details.
3. Deposit the amount you want to invest.
4. Choose an NSE-listed share, REIT or other available security.
5. Enter the quantity and price instructions.
6. Wait for the order to find a matching buyer or seller.
7. Check the trade confirmation and subsequent CDS statement.

An order can remain unfilled when nobody is willing to trade at your chosen price. Once an NSE equity trade executes, the formal exchange and depository process completes afterward. Our guide to [NSE settlement and T+3](/blog/nse-settlement-t-plus-3-explained-ziidi-trader/) explains the difference between placing, executing and settling an order.

If you are starting from zero, read the [complete beginner guide to investing in Kenya](/blog/complete-beginner-guide-to-investing-in-kenya/) before selecting your first asset. A CDS account gives you market access; it does not make every listed investment suitable.
...
Read the [complete Ziidi Trader guide](/blog/ziidi-trader-complete-guide-kenya/) for its onboarding process, ownership structure, fees and risks.
