...
Orders are matched on the NSE between willing buyers and sellers.
...
No.
This is one of the most important structural differences. Ziidi Trader uses an **omnibus account structure**.
Instead of each investor opening a personal CDS account:
...
For deeper details on the Safaricom + NSE setup, read: [Ziidi Trader Safaricom: M-PESA + NSE explained]({{ '/blog/ziidi-trader-safaricom-mpesa-nse-kenya/' | relative_url }})
...
For a detailed comparison, read: [Ziidi Trader vs Money Market Funds in Kenya]({{ '/blog/ziidi-trader-vs-money-market-funds-kenya/' | relative_url }})
